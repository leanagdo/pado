...
export class FullScreenComponent { 
    ...
    @HostListener('window:resize') onFullScreenChange(){
        ...
        let webkitFullscreen = null;
        if (document['webkitFullscreenElement']) {
            webkitFullscreen = document['webkitFullscreenElement'];
        }
         
        let fullscreenElement = fullscreen || document.mozFullScreenElement ||
                                webkitFullscreen || document.msFullscreenElement;
